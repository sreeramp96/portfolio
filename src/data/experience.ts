...
export const experience: ExperienceItem[] = [
  {
    ...
    description: 'Lead backend engineer on MissionOS — a multi-tenant SaaS platform ingesting real-time construction sensor data.',
    bullets: [
      'Reduced sensor dashboard query times from ~6–8s to under 500ms on 10M+ row tables via composite indexing and EXPLAIN-driven query restructuring — a 12× improvement.',
      ...
      'Built automated bulk reporting pipeline processing 50,000+ sensor points per run, generating PDFs and Highcharts visualisations — saving ~8 hrs/week.',
  ...
  },
  {
    ...
    description: 'Backend developer for enterprise financial-sector form applications, owning database architecture and stored procedure logic.',
    bullets: [
