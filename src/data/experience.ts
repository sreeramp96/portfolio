...
export const experience: ExperienceItem[] = [
  {
    ...
    description:
      "Lead backend engineer on MissionOS — a multi-tenant SaaS platform ingesting real-time construction sensor data.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Backend developer for enterprise financial-sector form applications, owning database architecture and stored procedure logic.",
    bullets: [
